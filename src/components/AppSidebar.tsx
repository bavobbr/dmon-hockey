...
const navigation = [
  ...
  },
  {
    ...
    icon: Trophy,
    items: [
      { title: "Training", url: "/sportief/training", icon: Calendar },
      { title: "Hoe Hockey Spelen", url: "/sportief/hoe-te-spelen", icon: BookOpen },
      {
        title: "Regels & Scheids",
        url: "/sportief/regels",
        icon: Timer,
        items: [
          { title: "U6 tot U8", url: "/sportief/regels/u6-u8", icon: Users },

        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Button variant="outline" className="h-auto p-4 justify-start" asChild>
                <a 
                  href="https://pub-5b8aee7e2e414ce7b4916802c52b86f6.r2.dev/DMON%20coach%20fundamentals%20bovenbouw%20v5.pptx" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  download
                >
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              <Button variant="outline" className="h-auto p-4 justify-start" asChild>
                <a 
                  href="https://pub-5b8aee7e2e414ce7b4916802c52b86f6.r2.dev/basistechnieken%20-%20tackles%20en%20dribbels%20v2.pptx" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  download
                >

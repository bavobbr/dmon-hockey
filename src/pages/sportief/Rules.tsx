...
import { Timer, Users, Award, Lightbulb, ExternalLink, BookOpen, ChevronRight, Bot, Mail, Whistle } from "lucide-react";
              ...
              <div className="relative flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/85">Laat het ons weten — we helpen je graag op weg.</p>
                  </div>
                </div>
                <Button asChild size="lg" variant="secondary">
                  <a href="mailto:info@dmon.be">Mail ons</a>
                </Button>
              </div>
            </div>
          </section>

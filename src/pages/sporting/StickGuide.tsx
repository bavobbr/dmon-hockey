        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground">
              Choosing the right hockey stick is crucial for performance and enjoyment. 
              Learn about different sizes, materials, and features to find the perfect stick for your needs.
            </p>
          </CardContent>
        </Card>
      </div>
